...
/*   Updated: 2023/11/03 16:53:29 by orazafy          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void printStatusPoints(const FragTrap &fragTrap)
{
...
int main(void)
{
	...
	{ // TEST: canonical format
		...
		FragTrap FragTrap1Bis;
		printStatusPoints(FragTrap1Bis);
		std::cout << std::endl;

		std::cout << "---------- Test of copy assignment ----------" << std::endl;
		FragTrap1Bis = FragTrap1;
		printStatusPoints(FragTrap1Bis);
		std::cout << std::endl;

		std::cout << "---------- Test of copy constructor ----------" << std::endl;
		FragTrap FragTrap1Ter(FragTrap1);
		printStatusPoints(FragTrap1Ter);
		std::cout << std::endl;
